...
- Thomas P. (Update for KSP 1.0, portation to Kopernicus as a base API, modular UI-Code)

**How to install**
If you want to test the current Development-Version, you have to put the Folder Source/DevelopmentBuild/KittopiaTech into your GameData folder. In-Game, the UI is opened with Ctrl + P.
